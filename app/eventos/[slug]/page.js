    ...
    <main style={styles.page}>
      <div style={styles.wrapper}>
        <div style={styles.brand}>
          {evento.imagen && (<div style={styles.eventImageWrap}> <img src={evento.imagen} alt={evento.nombre} style={styles.eventImage} /></div>)}
          {evento.tituloDescuento && (<div style={styles.tituloDescuentoBadge}>{evento.tituloDescuento}</div>)}
