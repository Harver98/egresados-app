    ...
    <main style={styles.page}>
      <div style={styles.wrapper}>
            ...
            <img
              ...
              onError={(e) => {
                ...
                e.target.parentNode.innerHTML =
                  '<div style="background:#fef2f2;border:1px solid #fee2e2;border-radius:14px;padding:12px 24px;color:#be1522;font-weight:700;font-size:18px;">ASEDUIS</div>'
              }}
            />
          </div>
        ...
        {resultado?.alerta_vencimiento && (
          <div style={{ ...styles.alertBase, ...styles.alertWarn }}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#d97706" strokeWidth="2.5" strokeLinecap="round" style={{ flexShrink: 0, marginTop: 1 }}>
              <path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/>
              <line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>
            </svg>
            <span style={{ fontWeight: 500 }}>{resultado.alerta_vencimiento}</span>
          </div>
        )}
        ...
        {resultado && (
          <div style={styles.resultCard(activo)}>
            ...
            <div style={styles.resultHeader(activo)}>
              ...
              <div>
                <p style={styles.statusLabel(activo)}>
                  {activo ? 'Afiliación activa' : 'Afiliación inactiva'}
                </p>
                <p style={styles.statusSub(activo)}>
                  {activo ? 'Al día con ASEDUIS' : 'Sin afiliación vigente'}
                </p>
              </div>
              <div style={styles.badge(activo)}>
            ...
            <div style={styles.resultBody}>
              ...
              {resultado.vigente_hasta && (
                <div style={styles.vigenciaRow}>
                  <div style={styles.vigenciaKey}>
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2" strokeLinecap="round">
                      <rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/>
                    </svg>
                    Vigente hasta
                  </div>
                  <span style={styles.vigenciaVal}>{resultado.vigente_hasta}</span>
                </div>
              )}
            </div>
          </div>
        ...
        <p style={styles.footer}>
          ...
          <br>Copyright © 2026 • Diseñado y Desarrollado por Alejandro Sierra</br>
        </p>
      </div>
