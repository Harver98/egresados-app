...
export default function ConsultaPage() {
  ...
  const styles = {
    ...
    logoWrap: { width: '100%', height: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
    logoImg: { width: 'auto', height: '100%', maxHeight: 200, objectFit: 'contain' },
